...
public class PinyinHelper {
    ...
    public static String toHanyuPinyinStringArray(String strChinese){
        return toHanyuPinyinStringArray(strChinese,true);
    }
    /**
    ...
    public static String toHanyuPinyinStringArray(String strChinese, boolean bUpCase){
