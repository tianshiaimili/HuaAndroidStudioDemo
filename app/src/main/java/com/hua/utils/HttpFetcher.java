...
//
///**
// * Created by sundh on 2015/11/12.
// */
//
...
//        }
//        try {
//            for (String str = CommonUtils.textCompress(paramString2); CommonUtils.isBlank(str); str = Base64.encodeToString(paramString2.getBytes(), 8)) {
//                return null;
//            }
...
//                localStringBuilder.append("&");
//            }
//            localArrayList.add(new BasicNameValuePair("data", str));
...
//            List localList = paramBuilder(paramString2, paramString3, paramString4, paramBoolean);
//            if (localList == null) {
//                return null;
//            }
//            localHttpPost.setEntity(new UrlEncodedFormEntity(localList, "UTF-8"));
//            HttpResponse localHttpResponse2 = getHttpClient().execute(localHttpPost);
