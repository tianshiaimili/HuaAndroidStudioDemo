...
public class HTMLSchemeActivity extends Activity {
	private WebView webView = null;
	public Handler handler = new Handler();

	private static final String SCHEME = "mama";//这个是在要打开的app中设置的scheme
...
//        webView.addJavascriptInterface(new MyObject(HTMLSchemeActivity.this,handler), "myObject");
        //加载assets目录下的文件
