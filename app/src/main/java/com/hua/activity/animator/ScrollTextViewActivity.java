...
import com.hua.R;
import com.hua.view.AutoTextSwitcher;
import com.hua.view.ScrollTextView;

import java.util.ArrayList;
import java.util.List;


public class ScrollTextViewActivity extends Activity {

    TextView textView;
    AutoTextSwitcher ad_content;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.scrolltext_layout);
        textView = (TextView)findViewById(R.id.test);
        textView.setMovementMethod(ScrollingMovementMethod.getInstance());
        ad_content = (AutoTextSwitcher) findViewById(R.id.test2);
        autoTextView();
    ...
    private void autoTextView(){
        ...
        textList.add("123");
        textList.add("123");
        ad_content.setData(textList);
        ad_content.startShow();
